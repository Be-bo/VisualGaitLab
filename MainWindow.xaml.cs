...
namespace VisualGaitLab
{
    public partial class MainWindow : Window {
        ...
        private void ShowDisclaimer() { //show some info about the current state of the program
            MessageBox.Show(
                "1. We STRONGLY recommend that you first quickly run through the entire process before committing to a project (to make sure VGL runs well on your machine).\n" +
                "2. For GAIT ANALYSIS: all videos must have the mouse facing the right side!\n", "Known Limitations & Issues", MessageBoxButton.OK, MessageBoxImage.Warning);
        }
